...
// @ts-ignore
import {useCreateTypeMutation,useUpdateTypeMutation,} from '@/graphql/type.graphql';
...
// @ts-ignore
import {AttachmentInput, Type, TypeSettingsInput,} from '__generated__/__types__';
