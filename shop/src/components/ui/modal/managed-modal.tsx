...
const CustomProductDetailsModalView = dynamic(
  () => import('@/components/products/details/custom-porduct-details'),
  { ssr: false }
);
...
const ManagedModal = () => {
  ...
  return (
    <Modal open={isOpen} onClose={closeModal}>
      ...
      {view === "CUSTOM_PRODUCT_DETAILS" && (
          <CustomProductDetailsModalView productSlug={data} />
      )}
      {view === 'SHOP_INFO' && (
        <ShopInfoCard
          shop={data?.shop}
